<template>
  <div class="section self-evaluation">
    <h3 class="section__title">
      ...
      <span class="section__title-text" contenteditable role="textbox" aria-label="模块标题" @keydown.enter.prevent @blur="saveTitle($event, 'evaluation')" v-text="getSectionTitle(store.currentResume, 'evaluation')"></span>
    </h3>
